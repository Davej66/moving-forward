...
function stripeElements() {
  ...
  //stripe = Stripe('settings.STRIPE_PUBLIC_KEY');
  stripe = Stripe('pk_test_51KkpyKHylLmfaYUcxfeNFtQqXC9FUzKdlgfLbvobMIMdyK8RDNk199dzBVPlXZgTLWSOkxoBtNRKoU5fYwKwy5w500szJ6Nr34');
